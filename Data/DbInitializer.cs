    ...
    public class DbInitializer
    {
        public static void Initialize(IServiceProvider serviceProvider)
        {
           ...
           LibraryContext(serviceProvider.GetRequiredService
            ...
            //    {
            //new Order{BookID=2,CustomerID=1,OrderDate=DateTime.Parse("2021-02-25")},
            //new Order{BookID=3,CustomerID=2,OrderDate=DateTime.Parse("2021-09-28")},
            //new Order{BookID=4,CustomerID=1,OrderDate=DateTime.Parse("2021-10-28")},
            //new Order{BookID=2,CustomerID=2,OrderDate=DateTime.Parse("2021-09-28")},
            //new Order{BookID=3,CustomerID=1,OrderDate=DateTime.Parse("2021-09-28")},
            //new Order{BookID=4,CustomerID=2,OrderDate=DateTime.Parse("2021-10-28")},
            //    };
